...
if contract_address:
  ...
  st.code("Audit this source code for any issues, use bullet points for your findings. Rewrite the code in solidity with solutions to these issues if they are found: "+ source_code)
